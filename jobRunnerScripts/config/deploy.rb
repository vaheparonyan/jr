...
set :application, "jobRunnerScripts"

set :scm, :git
set :repository, "git@github.groupondev.com:seo/jobRunnerScripts.git"
set :scm_passphrase, ""
...
set :deploy_to,   "/var/groupon/apps/job_runner/jobRunnerScripts"
set :keep_releases,  5
