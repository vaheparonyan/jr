DELETE FROM seo_analytics.cube_int_bld_session_metrics_rp_fcs where date_value = '@parameter_date';

SQL_BREAK;

REPLACE INTO seo_analytics.cube_int_bld_session_metrics_rp_fcs
...
from
    seo_analytics.int_bld_session_metrics_rp_fcs sm
