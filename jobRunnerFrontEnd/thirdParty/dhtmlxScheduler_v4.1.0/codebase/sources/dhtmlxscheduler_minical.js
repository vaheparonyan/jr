...
scheduler.form_blocks.calendar_time = {
	render: function() {
        ...
        var html1 = "<input class='dhx_readonly' type='text' readonly='true' style='visibility:hidden;'>";
		...
		return "<div style='height:30px;padding-top:0; font-size:inherit;' class='dhx_section_time'>" + html + "<span style='font-weight:normal; font-size:10pt; visibility:hidden;'> &nbsp;&ndash;&nbsp; </span>" + html1 + "</div>";
	},
